...
<head>
    ...
    <title>SYSCOOP AGRI Farm - Leowa Accociates</title>
</head>
<body>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-5 col-lg-4 col-md-10 d-none d-xl-block">
                                <img data-animation="fadeInUp" data-delay=".9s" src="/assets/img/undraw_not_found_60pq.svg" width="100%" alt="">
                            </div>
                        </div>
                    </div>
                </div>    
			...
			<div class="container box_1170">
                <div class="row mb-5">
                    ...
                    <h3 class="text-heading text-muted">One of the <strong>features</strong> include:</h3>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <img src="/assets/img/screenshots/ss_farm_1.jpg" style="width: 100%; margin-top: 40px; box-shadow: 10px 10px 40px rgba(0,0,0,0.1); border-radius: 10px;" alt="">
                            </div>
                            <div class="col-md-5">
                                <img src="/assets/img/screenshots/ss_farm_2.jpg" style="width: 100%; margin-top: 40px; box-shadow: 10px 10px 40px rgba(0,0,0,0.1); border-radius: 10px;" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 order-lg-1">
                        <?php $sidebar_active = 'syscoop-agri-farm'; include_once('../partials/products-menu.php'); ?>
                    </div>
                </div>
			</div>
		</section>
