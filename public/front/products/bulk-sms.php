...
<head>
    ...
    <title>Bulk SMS Solution - Leowa Accociates</title>
</head>
<body>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-5 col-lg-4 col-md-10 d-none d-xl-block">
                                <img data-animation="fadeInUp" data-delay=".9s" src="/assets/img/undraw_messages1_9ah2.svg" height="320px" alt="">
                            </div>
                        </div>
                    </div>
                </div>    
                ...
                <div class="row mb-5">
                    <div class="col-lg-9 order-lg-2">
                        <h3 class="text-heading text-muted" style="margin-top: 10px;">
                            ...
                            <img src="/assets/img/screenshots/bulk_sms.jpg" style="width: 100%; margin-top: 10px; box-shadow: 10px 10px 40px rgba(0,0,0,0.1); border-radius: 10px;" alt="">
                        </h3>
                    </div>
                    <div class="col-lg-3 order-lg-1">
                        <?php $sidebar_active = 'bulk-sms'; include_once('../partials/products-menu.php'); ?>
                    </div>
                </div>
			</div>
		</section>
