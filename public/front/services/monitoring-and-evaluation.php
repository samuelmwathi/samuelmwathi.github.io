...
<head>
    ...
    <title>ICT Solutions Provisions - Leowa Accociates</title>
</head>
<body>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-5 col-lg-4 col-md-10 d-none d-xl-block">
                                <img data-animation="fadeInUp" data-delay=".9s" src="/assets/img/undraw_observations_mejb.svg" width="100%" alt="">
                            </div>
                        </div>
                    </div>
                </div>    
			...
			<div class="container box_1170">
                <div class="row mb-5">
                    ...
                    <div class="col-lg-3 order-lg-1">
                        <?php $sidebar_active = 'monitoring-and-evaluation'; include_once('../partials/services-menu.php'); ?>
                    </div>
                </div>
			</div>
		</section>
