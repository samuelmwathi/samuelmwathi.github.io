...
<main>
                ...
                <div class="col-lg-7 col-md-12">
                    <div class="about-caption">
                        ...
                        <p class="pera-top mb-40">
                            We offer a wide range of services. Our clientele is both business organizations and not for profit organizations.<br>
                            We specialize in:
                        </p>
                        ...
                        <div class="icon-about">
                            <a href="services.php" class="btn btn-primary btn-md">More Details</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="testimonial-area testimonial-padding fix section-bg-testi" data-background="{{ asset('front/assets/img/gallery/section_bg01.png') }}">
        <div class="container">
    ...
    <!-- Blog Area Start -->
    <section class="home-blog-area section-padding30 pb-0">
        <div class="container">
            <!-- Section Tittle -->
    ...
    <!-- Our Clients Start-->
    <section class="home-blog-area section-padding30 pt-20">
        <div class="container">
            <!-- Section Tittle -->
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-9 col-sm-10">
