                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-5 col-lg-4 col-md-10 d-none d-xl-block">
                                <img data-animation="fadeInUp" data-delay=".9s" src="{{ asset('front/assets/img/undraw_flowers_vx06.svg') }}" width="100%" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-lg-9 order-lg-2">
                        ...
                        <h3 class="text-heading text-muted" style="margin-top: 80px;">
                            ...
                            <img src="{{ asset('front/assets/img/screenshots/dashboard.jpg') }}" style="width: 100%; margin-top: 10px; box-shadow: 10px 10px 40px rgba(0,0,0,0.1); border-radius: 10px;" alt="">
                        </h3>
                        ...
                        <h3 class="text-heading text-muted" style="margin-top: 20px;">
                            ...
                            <img src="{{ asset('front/assets/img/screenshots/inventory_module.png') }}" style="width: 100%; margin-top: 10px; box-shadow: 10px 10px 40px rgba(0,0,0,0.1); border-radius: 10px;" alt="">
                        </h3>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <h3 class="text-heading text-muted" style="margin-top: 20px;">
                                    ...
                                    <img src="{{ asset('front/assets/img/screenshots/inv-mod-ma.jpg') }}" style="width: 100%; margin-top: 10px; box-shadow: 10px 10px 40px rgba(0,0,0,0.1); border-radius: 10px;" alt="">
                                </h3>
                            </div>
                            <div class="col-md-3">
                                <h3 class="text-heading text-muted" style="margin-top: 20px;">
                                    Input sales receipt<br>
                                    <img src="{{ asset('front/assets/img/screenshots/input-sales-receipt.jpg') }}" style="width: 100%; margin-top: 10px; box-shadow: 10px 10px 40px rgba(0,0,0,0.1); border-radius: 10px;" alt="">
                                </h3>
                            </div>
                        </div>
