                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-md-12 p-5">
                                    ...
                                    <p class="text-muted mt-1 mb-4">Set your password.</p>
                                    @include('partials.info')

                                    <form action="{{ route('admin.users.activate.action') }}" method="post" class="authentication-form">
                                        @csrf
                                        ...
                                        <div class="form-group mb-0 text-center">
                                            <button class="btn btn-primary btn-block" type="submit"> Activate Account
                                            </button>
                                        </div>
                                    </form>
                                </div>
